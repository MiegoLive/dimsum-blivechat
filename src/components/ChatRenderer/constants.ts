...
export function getMedalConfig(level: number) {
  for (const config of MEDAL_CONFIGS) {
    if (level >= config.level) {
      return config
    }
  }
  return MEDAL_CONFIGS[MEDAL_CONFIGS.length - 1]
}
...
export function getShowContent(message: { translation: any; content: any }) {
...
export function getShowRichContent(message: { richContent: any; translation: any }) {
...
export function getShowRichContentThread(message: { richContents: any; threadLength: number; translation: any }) {
...
export function getGiftShowContent(message: { giftName: any; num: any }, showGiftInfo: any) {
  if (!showGiftInfo) {
    return ''
  }
  return t('chat.sendGift', { giftName: message.giftName, num: message.num })
}

export function getShowAuthorName(message: { authorNamePronunciation: any; authorName: any }) {
