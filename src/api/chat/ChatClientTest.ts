...
import { AUTHOR_TYPE_ADMIN, AUTHOR_TYPE_MEMBER, AUTHOR_TYPE_NORMAL, AUTHOR_TYPE_OWNER, Message, MESSAGE_TYPE_GIFT, MESSAGE_TYPE_INTERACT, MESSAGE_TYPE_MEMBER, MESSAGE_TYPE_SUPER_CHAT, MESSAGE_TYPE_TEXT } from "../../components/ChatRenderer/constants"
...
const NAMES = [
  ...
  '只熊KUMA', 'DoodleBear', '椅子_Official', '星界璃海', '玲玲', '海式policturn', '小川尚未', '梅林Kitsune', '因扎因·内比娅',
  '特里羊羊Terry', '特里羊羊Terry', '特里羊羊Terry', '特里羊羊Terry', '特里羊羊Terry', '特里羊羊Terry', '特里羊羊Terry', '特里羊羊Terry',
  '特里羊羊Terry', '特里羊羊Terry', '特里羊羊Terry', '特里羊羊Terry', '特里羊羊Terry', '特里羊羊Terry', '特里羊羊Terry', '特里羊羊Terry',
  '蘇米suminya', '蘇米suminya', '蘇米suminya', '蘇米suminya', '蘇米suminya', '蘇米suminya', '蘇米suminya', '蘇米suminya', '蘇米suminya',
  '蘇米suminya', '蘇米suminya', '蘇米suminya', '蘇米suminya', '蘇米suminya', '蘇米suminya', '蘇米suminya', '蘇米suminya', '蘇米suminya',
  'Miego糕社', 'Miego糕社', 'Miego糕社', 'Miego糕社', 'Miego糕社', 'Miego糕社', 'Miego糕社', 'Miego糕社', 'Miego糕社', 'Miego糕社', 'Miego糕社',
  'Miego糕社', 'Miego糕社', 'Miego糕社', 'Miego糕社', 'Miego糕社', 'Miego糕社', 'Miego糕社', 'Miego糕社', 'Miego糕社', 'Miego糕社', 'Miego糕社',
  '月迷moonmi', '月迷moonmi', '月迷moonmi', '月迷moonmi', '月迷moonmi', '月迷moonmi', '月迷moonmi', '月迷moonmi', '月迷moonmi', '月迷moonmi',
  '洛卡梅尼', '洛卡梅尼', '洛卡梅尼', '洛卡梅尼', '洛卡梅尼', '洛卡梅尼', '洛卡梅尼', '洛卡梅尼', '洛卡梅尼', '洛卡梅尼', '洛卡梅尼', '洛卡梅尼',
]
...
const AUTHOR_TYPES = [
  { weight: 2, value: AUTHOR_TYPE_NORMAL },
  { weight: 3, value: AUTHOR_TYPE_MEMBER },
  { weight: 1, value: AUTHOR_TYPE_ADMIN },
  { weight: 1, value: AUTHOR_TYPE_OWNER }
]

function randGuardInfo() {
  let authorType = randomChoose(AUTHOR_TYPES)
  let privilegeType
  if (authorType === AUTHOR_TYPE_MEMBER) {
    privilegeType = randInt(1, 3)
  } else if (authorType === AUTHOR_TYPE_ADMIN) {
...
function randomChoose(nodes: any[]) {
  if (nodes.length === 0) {
    return null
  }
...
export default class ChatClientTest {
  ...
  timerId?: number
  constructor(minSleepTime: number, maxSleepTime: number) {
