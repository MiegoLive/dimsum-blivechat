...
export const DEFAULT_CONFIG: Config = {
  ...
  compatibilityMedalLevelToGuardLevelEnabled: false,
  compatibilityMedalLevelToGuardLevel: [7, 11, 15],
...
export function setLocalConfig(config: Config) {
...
export function sanitizeConfig(config: Config) {
  let newEmoticons = []
